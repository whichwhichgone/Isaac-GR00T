...
DATE="2026-07-22"
REPO_NAME="all_points_rel_legato_stage1"
OUTPUT_PATH="/liujinxin/liyifan/Isaac-GR00T/dataset/${REPO_NAME}"
DATASET_PATH_1="/liujinxin/liyifan/Isaac-GR00T/dataset/G1_real_6D_window_cont_rel_0526-0601_all_points_rel"
DATASET_PATH_2="/liujinxin/liyifan/Isaac-GR00T/dataset/pick_cube_bottle_g1_0616_0617_0623_0624_0625_0626_all_points_rel"
DATASET_PATH_3="/liujinxin/liyifan/Isaac-GR00T/dataset/pick_cube_bottle_g1_0626_0629_all_points_rel"
...
#     --embodiment-tag "${EMBODIMENT_TAG_3}"
...
torchrun --nproc_per_node="${NUM_GPUS}" --master_port=29500 \
    ...
    --dataset_embodiment_tags "${EMBODIMENT_TAG_3}" "${EMBODIMENT_TAG_1}" \
    --dataset_mix_ratios "1" "2" \
    --num_gpus "${NUM_GPUS}" \
    --output-dir "./checkpoints/${DATE}_${REPO_NAME}" \
    --save_total_limit 5 \
    --save-steps 5000 \
    --max-steps 50000 \
    --body_action_dim 102 \
