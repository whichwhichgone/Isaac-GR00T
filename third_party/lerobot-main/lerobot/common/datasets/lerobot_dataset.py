...
LEROBOT_HOME = Path(os.getenv("LEROBOT_HOME", "/liujinxin/liyifan/Isaac-GR00T/dataset")).expanduser()
...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def _save_episode_table(self, episode_buffer: dict, episode_index: int) -> None:
        ...
        for key, value in episode_dict.items():
            print(f"{key}: type={type(value)}, sample={value[0]}")
        print(self.hf_features)
