...
torchrun --nproc_per_node=$NUM_GPUS --master_port=29500 \
    ...
    --dataset_path /liujinxin/zhaowei/G1_MOTION/data/G1_real_6D_window_cont_rel_hand_all \
    --embodiment_tag UNITREE_G1_29DOF \
    --num_gpus $NUM_GPUS \
    --output_dir logs_output/g1_29dof_finetune_real_6D_window_cont_rel_hand_all \
    --save_total_limit 3 \
    --max_steps 40000 \
    --save_steps 10000 \
    --warmup_ratio 0.05 \
