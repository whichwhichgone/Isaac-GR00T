...
torchrun --nproc_per_node=$NUM_GPUS --master_port=29500 \
    ...
    --dataset_path /liujinxin/zhaowei/Isaac-GR00T/examples/GR00T-WholeBodyControl/G1_real_6D_window \
    --embodiment_tag UNITREE_G1_29DOF \
    --num_gpus $NUM_GPUS \
    --output_dir logs_output/g1_29dof_finetune_real_6D_window_offset \
    --save_total_limit 3 \
    --max_steps 25000 \
    --save_steps 5000 \
    --warmup_ratio 0.05 \
