    ...
    def _create_model(self):
        ...
        if self.config.training.start_from_checkpoint is not None:
            ...
            model, loading_info = AutoModel.from_pretrained(
                ...
                selected_action_dims=self.config.model.selected_action_dims,
                selected_action_weight=self.config.model.selected_action_weight,
    ...
    def _create_dataset(self, save_cfg_dir: Path):
        ...
        if self.config.training.start_from_checkpoint is not None:
            processor = AutoProcessor.from_pretrained(
                ...
                action_chunk_size=self.model_config.action_chunk_size,
                execution_action_horizon=self.model_config.action_horizon,
